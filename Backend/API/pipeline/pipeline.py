...
def clean_articles(articles_dataframe):
    ...
    articles_dataframe['Extracted_Number_final'] = articles_dataframe['Extracted_Number_final'].astype(int, errors='ignore')
    articles_dataFrame_clean = articles_dataframe[['Doc_id','Extracted_Number_final','Body']]
...
def scrap_the_pdf(business_number):
    ...
    if is_pdf_scraped:
        ...
        if is_french:
            ...
            display(articles_dataFrame)
            pdf_info_as_json = articles_dataFrame.to_json()
